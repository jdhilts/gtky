...
function Header(){
	return(
		...
		<svg className="link white-90 hover-white" data-icon="skull" viewBox="0 0 32 32" style={{'fill':'currentcolor'}}>
		...
		<a className="f6 no-underline grow dib v-mid white ba b--white ph3 pv2 mb3" href="null">Secondary call to action</a>
		</div>
		</div>
		</div> 
		</header>
